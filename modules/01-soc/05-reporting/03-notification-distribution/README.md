...
**Path:** `modules/01-soc/05-reporting/03-notification-distribution`  
...
The teaching-unit ID is **1.5.3**. It closes unit **1.5**. Report types are **1.5.1**. Timelines are **1.5.2**. Shift change is **1.7**. Classroom chart below is for this lesson only.
