...
The teaching-unit ID is **1.1.5**. Process activity is **1.1.2**. File system activity is **1.1.3**. Host-observed network is **1.1.4**. Image/driver load is **1.1.6**. Persistence *how-to* is **2.6**. This lesson does not teach Sysmon install or config.
