...
- How it hooks to the hour after: 1.1.2 is file activity on the same host telemetry.
...
**Mapped Items:** K 1.1.1.1 ; T 1.1.1.2 ; T 1.1.1.3
...
If they open a file path as the story: “1.1.2. Stay on the process row.”  
...
2. **wscript (Temp vbs) → powershell -enc. What occurred?**  
   ...
   **Explanation:** Outline a–c and 1.1.1.1 task 1.
