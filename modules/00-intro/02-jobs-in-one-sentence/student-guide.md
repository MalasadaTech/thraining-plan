...
- K: 0.2 – Jobs in one sentence

---

## 1. Key Concepts

**0.1** said a SOC is a team sport. This hour names the jobs. How work moves between them is **0.3**. One person may do more than one job — that is **0.4**.
