...
- K: 0.4 – Where the jobs lightly overlap

---

## 1. Key Concepts

**0.3** named one possible path. This hour is the overlap. Everyone may look at the same **host**, **log**, or **domain**. That does not make the jobs the same.
...
**Next:** **0.5** How this course is laid out.
