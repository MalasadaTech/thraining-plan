...
This hour is **where things sit** on the site. How you **download** or **view** PCAP is tool access (**1.8.3**) if the shop lists them. Zeek field reading is **1.2**. Why you pull PCAP is **1.2.1**. Host-observed network is **1.1.4**.
...
| This lesson | Other |
|-------------|-------|
| Where the sensor *is* | How to export/view PCAP — **1.8.3** if the shop lists them |
...
**Lead:** Do not promise a download from a sensor that does not exist.
...
3. Do not download PCAP. Do not open a tool URL (**1.8.3**). Do not write the IR step (**1.8.5**).
...
- Next: tool access (**1.8.3**). Why you pull PCAP is **1.2.1**.
...
- Related modules:
  ...
  - 1.8.3 – Tool access (next)
  - 1.2.1 – Zeek concepts (why you pull PCAP)
