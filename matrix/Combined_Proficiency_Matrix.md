...
## 1. Endpoint Logs & Telemetry Analysis (Primarily SOC)
...
## 2. Zeek & Network Telemetry (Primarily SOC + Hunter)
...
## 3. Detection Engineering (Primarily SOC)
...
## 4. Alert Handling (Primarily SOC)
...
## 5. Frameworks (Shared across all roles)
...
## 6. Reporting & Shift Processes (Primarily SOC)
...
## 9. Site-Specific Operational Knowledge (Mixed)
